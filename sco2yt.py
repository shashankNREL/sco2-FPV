...
def CM23(Z1m, Z2m, Z1var, Z2var, meshZ1, dZ1, center_move_frac = 0.5, eps=1e-10):
    # get meshes
...
def outputPDFs(odir, numvol):
    for i in range(numvol):
        ...
        np.savez_compressed(outname + ".npz", PDF=PDF, bins1=binsA, bins1=binsB, dz=dzAB, cm23=CM23pdf)
